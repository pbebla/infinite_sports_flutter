...
{
    public class FlagFootballGame : Game
    {
        ...
        public Dictionary<string, Flag footballPlayer> team1lineup { get; set; }

        public Dictionary<string, Flag footballPlayer> team2lineup { get; set; }
